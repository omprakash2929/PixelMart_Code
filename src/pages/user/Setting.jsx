...
const Setting = () => {
  ...
  return (
    <Layout>
      <div className="w-full sm:bg-gray-50 sm:px-8">
        <div className="w-full flex  flex-row">
          ...
          <div className="col-span-8  overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
            ...
            <form action=""  >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <p className="text-gray-600">
                  ...
                  <strong  onChange={()=> setEmail(auth?.user?.email)}
                            value={email}>
                    {auth?.user?.email}
                  </strong>
                </p>
            ...
            <button type="button" onClick={handleSubmit} className="mt-4 rounded-lg bg-blue-600 px-4 py-2 text-white">
              Save Password
            </button>
            </form>
            <hr className="mt-4 mb-8" />
