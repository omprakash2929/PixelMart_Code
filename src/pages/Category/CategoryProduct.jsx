  ...
  return (
    <Layout>
      <div className=" flex flex-col xl:flex-row justify-center ">
        <div className="bg-white sticky bottom-0 hidden xl:flex">
          <div className="">
            <main className="mx-auto xl:w-[18rem] 2xl:max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden xl:grid mx-auto  grid-cols-1 2xl:grid-cols-4 xl:grid-cols-3 justify-items-center justify-center gap-x-10   mt-10 mb-5   ">
          {products?.map((p) => (
            <div
