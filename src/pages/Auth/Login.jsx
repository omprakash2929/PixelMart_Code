    ...
    <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            ...
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                <div className="text-center pb-8">
                    <img src="https://github.com/omprakash2929/Image/blob/main/logo/logo.png?raw=true" width={300} className="mx-auto" />
                    <div className="mt-5">
                ...
                >
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <Link to="/forgot-password"  className="text-center text-indigo-600 hover:text-indigo-500">Forgot password?</Link>
                    </div>
                    <button
